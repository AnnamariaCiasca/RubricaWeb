...
import model.entities.util.DBUtil;
...
public class ContactDao {
	...
	public static List<Contact> findAllNamedQuery() {
		EntityManager em = DBUtil.getEntityManager(DBUtil.RUBRICA_WEB_PU);
		return em.createNamedQuery("Contact.findAll", Contact.class).getResultList();  //ci consente di usare la query inserita sulla entity
	}
